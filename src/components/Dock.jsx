...
export function Dock({ items, onOpen }) {
  return (
    <div className="relative mx-auto w-full max-w-[940px] px-3 pb-3 sm:px-5 sm:pb-4">
      <div className="h-[52px] rounded-[8px] border border-ink/40 bg-slot/85 shadow-[0_-1px_0_rgba(255,255,255,0.35)_inset] backdrop-blur-sm sm:h-[58px]" />
